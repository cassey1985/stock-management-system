  ...
  const downloadReportAsWord = () => {
    ...
    <head>
        ...
        <style>
            ...
            .metric-row { display: table; width: 100%; margin-bottom: 10px; }
            .metric-cell { display: table-cell; width: 50%; padding: 10px; border: 1px solid #ccc; }
            .metric-title { font-weight: bold; }
            .metric-value { font-size: 18px; font-weight: bold; margin-top: 5px; }
            .positive { color: green; }
            .negative { color: red; }
            .section { margin-bottom: 30px; }
            .category-item { margin-bottom: 5px; padding: 5px 0; border-bottom: 1px solid #eee; }
      ...
      {/* Comprehensive Financial Summary */}
              ...
              {reportData && (
                <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                  <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white p-4">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-green-100">Period: {reportData.period}</p>
                      </div>
                      <button
                        onClick={downloadReport}
                        className="bg-white text-green-600 px-4 py-2 rounded-md hover:bg-gray-50 font-medium flex items-center gap-2"
                      >
                        � Download CSV
                      </button>
                    </div>
                  ...
                  <div className="p-6 bg-gray-50">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div className="bg-white p-4 rounded-lg border-l-4 border-green-500">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-xl font-bold text-green-600">{formatCurrency(reportData.metrics.totalIncome)}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white p-4 rounded-lg border-l-4 border-red-500">
                        <div className="flex items-center">
                          <div className="text-3xl text-red-500 mr-3">💸</div>
                          <div>
                            <p className="text-sm text-gray-600 font-medium">Total Expenses</p>
                            <p className="text-xl font-bold text-red-600">{formatCurrency(reportData.metrics.totalExpenses)}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white p-4 rounded-lg border-l-4 border-blue-500">
                        <div className="flex items-center">
                          <div className="text-3xl text-blue-500 mr-3">📊</div>
                          <div>
                            <p className="text-sm text-gray-600 font-medium">Net Position</p>
                            <p className={`text-xl font-bold ${reportData.metrics.netPosition >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                      ...
                      <div className="bg-white p-4 rounded-lg border-l-4 border-purple-500">
                        <div className="flex items-center">
                          <div className="text-3xl text-purple-500 mr-3">📋</div>
                          <div>
                            <p className="text-sm text-gray-600 font-medium">Transactions</p>
                            <p className="text-xl font-bold text-purple-600">{reportData.metrics.transactionCount}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Transaction Details */}
                  <div className="p-6">
                    <h4 className="text-lg font-semibold mb-4 text-gray-800">📄 Transaction Details</h4>
                      ...
                      <table className="w-full border-collapse bg-white">
                        <thead className="bg-gray-100 sticky top-0">
                          <tr>
                            ...
                            <th className="text-right py-3 px-4 font-semibold text-gray-700 border-b">Debit</th>
                            <th className="text-right py-3 px-4 font-semibold text-gray-700 border-b">Credit</th>
                          </tr>
                        </thead>
                        <tbody>
